...
這是一個 Codex/Hermes-style skill，基於本機 EP1-EP673 逐字稿與公開資料蒸餾，用來在使用者明確要求「股癌視角」「主委會怎麼看」「Gooaye perspective」時，輸出灰階、產業鏈、部位、風險與生活配置式的判斷框架。EP672 已改用公開逐字稿；EP673 目前為 SoundOn 音檔機器轉錄暫定版，待公開逐字稿出現後替換。
